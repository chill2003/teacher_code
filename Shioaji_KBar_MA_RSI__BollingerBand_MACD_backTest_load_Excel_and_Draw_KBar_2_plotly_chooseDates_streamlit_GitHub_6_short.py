...
KBar_dic['product'] = np.repeat('Yulon', KBar_dic['open'].size)
...
cycle_duration = st.sidebar.number_input('輸入一根 K 棒的時間長度(天)', value=1)
...
KBar_dic['product'] = np.repeat('Yulon', KBar_dic['time'].size)
